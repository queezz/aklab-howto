...
- 🔵 Some topics are deep, others are just reminders
...
- 📦 project structure and small tools
- 🐍 Python packages and environments
- 🔁 reproducibility, scripts, and automation
- ✂️ things that save time instead of adding abstraction

Expect uneven depth — this mirrors real work.

---

## 🔧 Lab hardware & experimental tools
...
- 🔍 small but important tools that don’t fit in manuals
- 🧪 experimental assemblies as they exist *right now*
...
(See [Software & tools](other-tools.md) for the curated list.)
